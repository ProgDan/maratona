...
${OBJECTDIR}/OBI2000/BIT.o: OBI2000/BIT.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/OBI2000/BIT.o OBI2000/BIT.cpp

${OBJECTDIR}/OBI2000/MACACO.o: OBI2000/MACACO.cpp 
	${MKDIR} -p ${OBJECTDIR}/OBI2000
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/OBI2000/MACACO.o OBI2000/MACACO.cpp

${OBJECTDIR}/OBI2000/QUERM.o: OBI2000/QUERM.cpp 
	${MKDIR} -p ${OBJECTDIR}/OBI2000
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/OBI2000/QUERM.o OBI2000/QUERM.cpp

${OBJECTDIR}/OBI2000/REDOTICA.o: OBI2000/REDOTICA.cpp 
	${MKDIR} -p ${OBJECTDIR}/OBI2000
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/OBI2000/REDOTICA.o OBI2000/REDOTICA.cpp

${OBJECTDIR}/OBI2000/SALDO.o: OBI2000/SALDO.cpp 
	${MKDIR} -p ${OBJECTDIR}/OBI2000
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/OBI2000/SALDO.o OBI2000/SALDO.cpp

${OBJECTDIR}/OBI2001/METEORO.o: OBI2001/METEORO.cpp 
	${MKDIR} -p ${OBJECTDIR}/OBI2001
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/OBI2001/METEORO.o OBI2001/METEORO.cpp
